...
import { sourcesApi } from '@/modules/open-notebook/lib/api/sources'
 ...
 */
export function useNotebookSources(notebookId) {
...
export function useCreateSource() {
  ...
  return useMutation({
    mutationFn: (data) => sourcesApi.create(data),
...
export function useSourceStatus(sourceId, enabled = true) {
  return useQuery({
...
export function useRetrySource() {
  ...
  return useMutation({
    mutationFn: (sourceId) => sourcesApi.retry(sourceId),
...
export function useAddSourcesToNotebook() {
  ...
  return useMutation({
    mutationFn: async ({ notebookId, sourceIds }) => {
      const { notebooksApi } = await import('@/modules/open-notebook/lib/api/notebooks')
...
export function useRemoveSourceFromNotebook() {
  ...
  return useMutation({
    mutationFn: async ({ notebookId, sourceId }) => {
