...
function findSpeakerSummary(speakerProfiles, speakerConfigName) {
  if (!speakerConfigName) return null
  return speakerProfiles.find((p) => p.name === speakerConfigName) || null
}
