...
export function SourceTypeStep({ control, register, setValue, errors, urlValidationErrors, onClearUrlErrors }) {
                ...
                <TabsContent key={type.value} value={type.value} className="mt-4">
                  ...
                  {type.value === 'text' && (
                    <div>
                      ...
                      {hasHtmlContent && (
                        <div className="mb-2 p-2 bg-primary-50 dark:bg-primary-950 border border-primary-200 dark:border-primary-700 rounded-md">
