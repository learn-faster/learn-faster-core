  ...
  >
    <defs>
      <radialGradient id="haloGlow" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="translate(32 26) rotate(90) scale(30)">
        ...
        <stop offset="0.45" stopColor="#F59E0B" stopOpacity="0.25" />
      ...
      <linearGradient id="accretionRing" x1="6" y1="32" x2="58" y2="32" gradientUnits="userSpaceOnUse">
        ...
        <stop offset="0.25" stopColor="#F59E0B" stopOpacity="0.5" />
        <stop offset="0.5" stopColor="#FCD34D" stopOpacity="0.95" />
        <stop offset="0.75" stopColor="#F59E0B" stopOpacity="0.5" />
    ...
    <circle cx="32" cy="32" r="14.5" stroke="rgba(251,191,36,0.2)" strokeWidth="1.2" />
    <circle cx="16" cy="18" r="1.4" fill="#FCD34D" />
    <circle cx="50" cy="16" r="1.2" fill="#FDE68A" />
    <circle cx="48" cy="46" r="1.6" fill="#F59E0B" />
  </svg>
);
